...
public class Parser {
    ...
    public Lexer l;//词法分析器
    public ArrayList<String> errors = new ArrayList<>();
    public Token curToken;//当前词法单元
    public Token peekToken;
    public HashMap<String,prefixParseFn> prefixParseFns = new HashMap<>();//解析前缀表达式
    public HashMap<String,infixParseFn> infixParseFns = new HashMap<>();//解析中缀表达式
