...
public class Builtins {
    ...
    public static Object.BuiltinFunction REST = (Object... args) -> {
        ...
        var length = arr.Elements.size();
        if(length>0){
            List<Object> sub=arr.Elements.subList(1,arr.Elements.size());
            ArrayList<object.Object> newElements = new ArrayList<>(sub);
            return new object.Object.Array(newElements);
        }
    ...
    public static Object.BuiltinFunction PUSH = (Object... args) -> {
        ...
        if(length>0){
            arr.Elements.add(0,args[1]);
            return new object.Object.Array(arr.Elements);
        }
        return  null;
        /*
        var newElements = new ArrayList<>(Arrays.asList(Arrays.copyOfRange(arr.Elements.toArray(), 0, length)));
